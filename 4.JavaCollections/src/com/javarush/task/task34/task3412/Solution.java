...
public class Solution {
    ...
    public Solution(int value1, String value2, Date value3) {
        logger.debug(String.format("Solution (value1 = %d, value2 = %s, value3 = %tc)", value1, value2, value3));
        this.value1 = value1;
        this.value2 = value2;
        this.value3 = value3;
    }
    ...
    public void calculateAndSetValue3(long value) {
        ...
        if (value > Integer.MAX_VALUE) {
            ...
            logger.debug("calculateAndSetValue3 (value1 = " + value / Integer.MAX_VALUE + ")");
        } else {
            value1 = (int) value;
            logger.debug("calculateAndSetValue3 (value1 = " + value + ")");
        }
    }
